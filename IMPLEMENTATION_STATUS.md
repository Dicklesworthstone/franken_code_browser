...
| `crates/fcb-source` — provider seam | Source provider and capture capability seam. Evidence: `crates/fcb-source/tests/provider_seam.rs`, 23 tests green at revision `7f49bf89`; serves bead `fcb-6up6.2` (closed) |
