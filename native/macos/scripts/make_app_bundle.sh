...
xcrun swiftc "$@" swiftui/AtlasCamera.swift swiftui/AtlasSource.swift swiftui/AtlasSearch.swift swiftui/AtlasSearchCoordinator.swift swiftui/AtlasSearchWorker.swift swiftui/AtlasMatch.swift swiftui/AtlasDocument.swift swiftui/AtlasPreparedText.swift swiftui/AtlasProjectCache.swift swiftui/AppStoreRootAccess.swift swiftui/AtlasMetalRasterRenderer.swift swiftui/AtlasMetalGlyphRenderer.swift swiftui/AtlasMetalPresentation.swift swiftui/AtlasRetainedView.swift swiftui/AtlasParcelLayout.swift swiftui/App.swift "$BRIDGE" \
